                      ...
                      <div class="mt-6 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                        <dl class="grid grid-cols-2 gap-x-4 gap-y-8">
                          <div class="sm:col-span-6">
                            <TextInputComponent
                              id="profilbildInput"
                              v-model="apartment.profile_image"
                              label="Profilbild"
                              @input="checkInput"
                            ></TextInputComponent>
                          </div>
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    data(): {
      ...
      return {
        apartment: { tenant: null } as Apartment,
        open: false,
        formValid: false,
      }
    },
    methods: {
      checkInput() {
        ...
        if (this.apartment.profile_image !== '') {
          this.apartment.profile_image = this.apartment.profile_image.replace(
            new RegExp('\\?.*', 'gm'),
      ...
      confirm(): void {
        if (this.formValid) {
          this.$emit('createApartment', this.apartment)
          this.open = false
          this.apartment = { tenant: null } as Apartment
        }
      },
    },
  })
